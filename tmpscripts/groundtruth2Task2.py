...
def main():
    ...
    for cls in util.wordname_15_new:
        fd = open(os.path.join(r'I:\dota\testset\Task1format_gt', r'Task2_' + cls + r'.txt'), r'w')
        filedict[cls] = fd

    for name in namelist:
        filepath = os.path.join(r'I:\dota\testset\ReclabelTxt-utf-8', name + '.txt')
        objects = util.parse_dota_poly(filepath)
        for obj in objects:
            category = obj['name']
            poly = obj['poly']
